...
public class AndyMath implements SapphireObject<OahuPolicy> {
	...
	public double arcLength(String f, String v, String a, String b) throws ParseError {
		Expression fun;
		...
		try{
			...
			throw new ParseError(e.getMessage(), e.context);
		}
	 ...
	 */
	private  String cleanUp(String d){
	...
	public String getDerivative(String fun, String[] var, String resp) throws ParseError{
		...
		throw new ParseError("", new ParserContext(resp, 0, null));
	}
	
	public String getFunctionVal(String fun, String[] var, String resp, String[] vals) throws ParseError{
		Parser parParser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
				| Parser.BRACES | Parser.BRACKETS| Parser.BOOLEANS);
		if(var.length != vals.length){
			throw new ParseError(" f'.", new ParserContext(resp, 0, null));
		}
	...
	public  double getDerivativeVal(String f, String v, String s) throws ParseError{
	...
	public double getFunctionVal(String f, double s) throws ParseError{
		Parser tempP = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
				| Parser.BRACES | Parser.BRACKETS| Parser.BOOLEANS);
	...
	public  String getPowerSeries(String fun, String v, String cen, int iter)
			throws ParseError {
		Variable var = new Variable(v);
		Parser parser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
	...
	//variable to integrate on
	//start value
	//end value
	public  double integrate(String fun, String v, String aS, String bS) throws ParseError {
		...
		double out = romberg(12,12);
		System.out.println("Execution time:	" + (System.nanoTime() - start));
		return out;
	}
	
	public  double integrate(String fun, String v1, String v2, String[] bounds){
		double x1, x2;
	...
	public  boolean isValid(String fun, String[] var){
		Parser parParser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
				| Parser.BRACES | Parser.BRACKETS| Parser.BOOLEANS);
		for(String v: var){
	...
	public  void setUpParser(Parser p) {
	...
	public  double surfaceArea(String fun, String v1, String v2, String[] bounds) throws ParseError{
		Variable integVarX = new Variable(v1);
		Variable integVarY = new Variable(v2);
		Parser integParser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
	...
	public  double getFunctionVal(String f, String v, String x){
		Variable var = new Variable(v);
		Expression fun,val;
		Parser parser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
	...
	// (y-y0)=m(x-x0)
	public  String tangentLine(String f, String x, String v) throws ParseError {
		Variable var = new Variable(v);
		Parser parser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
				| Parser.OPTIONAL_STARS | Parser.OPTIONAL_SPACES
				| Parser.BRACES | Parser.BRACKETS| Parser.BOOLEANS);
		...
		try {
			...
			try {
				...
				throw new ParseError("", e.context);
			}
		} catch (ParseError e) {
			throw new ParseError("", e.context);
		}
	...
	public  Matrix stringToMatrix(String s) throws IllegalArgumentException, ParseError{
		if(s == null || s.equals("")){
			return null;
		}
		Parser parser = new Parser(Parser.STANDARD_FUNCTIONS | Parser.OPTIONAL_PARENS
