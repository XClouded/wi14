...
public class TwimightBaseActivity extends FragmentActivity{
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		case R.id.menu_my_profile:
			...
			System.out.println("Querying for users; user = " + LoginActivity.getTwitterId(this));
			Cursor c = getContentResolver().query(uri, null, TwitterUsers.COL_SCREENNAME+"=\""+LoginActivity.getTwitterId(this) +"\"", null, null);
