...
import sapphire.appexamples.minnietwitter.device.twimight.activities.NewDMActivity;
		...
		protected void onPostExecute(Integer result) {
			...
			if(ex != null){
				...
				if(result!=null) {
					...
					cv.put(Tweets.COL_RETWEETED_BY, LoginActivity.getTwitterId(getApplicationContext()));
				}
