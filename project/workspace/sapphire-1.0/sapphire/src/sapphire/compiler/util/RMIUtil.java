 ...
 */
package sapphire.compiler.util;
...
public final class RMIUtil {
	...
	public static boolean checkRemoteInterface(Class iface)
		...
		methods:
			for (int i = 0; i < methods.length; i++) {
				...
				throw new IllegalArgumentException(iface.getName() + " is not a valid remote interface: method "
						+ getBasicMethodSignature(method) + " must throw java.rmi.RemoteException");
			}
		return true;
	}
	...
	public static Class getRemoteClass(Class cls)
		...
		throw new IllegalArgumentException("The specified class is not remote"); //$NON-NLS-1$
	}
