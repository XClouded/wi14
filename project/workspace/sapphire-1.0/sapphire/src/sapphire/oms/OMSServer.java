...
public interface OMSServer extends Remote {
       ...
       ArrayList<InetSocketAddress> getDevices() throws RemoteException;
       InetSocketAddress getServerInRegion(String region) throws RemoteException;
       void setServerToRegion(String region, InetSocketAddress address) throws RemoteException;
       
       void registerKernelServer(InetSocketAddress host) throws RemoteException, NotBoundException;
       void registerKernelDeviceServer(InetSocketAddress host) throws RemoteException, NotBoundException;
