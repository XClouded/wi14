...
import sapphire.compiler.util.RMIUtil;
...
public abstract class SapphirePolicyLibrary implements SapphirePolicyUpcalls {
	...
	public static abstract class SapphireServerPolicyLibrary implements SapphireServerPolicyUpcalls {
		...
		public void sapphire_pin(InetSocketAddress server) throws RemoteException {
		...
		public String sapphire_durable_put(Object value) {
			String key = Integer.valueOf(value.hashCode()).toString();
			GlobalKernelReferences.nodeServer.getKernelStore().put(key, value);
			return key;
		}
		
		public Object sapphire_durable_get(String key) {
			return GlobalKernelReferences.nodeServer.getKernelStore().get(key);
		}
	...
	public static abstract class SapphireGroupPolicyLibrary implements SapphireGroupPolicyUpcalls {
		...
		public ArrayList<InetSocketAddress> sapphire_getDeviceServers() throws RemoteException {
			return oms().getDevices();
		}
