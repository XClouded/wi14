/*
 * Stub for class sapphire.policy.replicate.ConsensusReplication.ConsensusReplicateGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ConsensusReplication$ConsensusReplicateGroupPolicy_Stub extends sapphire.policy.replicate.ConsensusReplication.ConsensusReplicateGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ConsensusReplication$ConsensusReplicateGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ConsensusReplication$ConsensusReplicateGroupPolicy_Stub other = (ConsensusReplication$ConsensusReplicateGroupPolicy_Stub) obj;
    ...
    public sapphire.policy.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireServerPolicy sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.onRefRequest()";
    ...
    public void onFailure(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.onFailure(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
    ...
    public sapphire.policy.replicate.ConsensusReplication.View getView() {
        String $__method = "public sapphire.policy.replicate.ConsensusReplication$View sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.getView()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        ...
        return ((sapphire.policy.replicate.ConsensusReplication.View) $__result);
    }

    // Implementation of getServers()
    public java.util.ArrayList getServers() {
        String $__method = "public java.util.ArrayList<sapphire.policy.SapphirePolicy$SapphireServerPolicy> sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.getServers()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public void addServer(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.replicate.ConsensusReplication$ConsensusReplicateGroupPolicy.addServer(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
