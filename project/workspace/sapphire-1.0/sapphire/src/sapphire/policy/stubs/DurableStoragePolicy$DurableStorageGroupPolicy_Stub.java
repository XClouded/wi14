/*
 * Stub for class sapphire.policy.durable.DurableStoragePolicy.DurableStorageGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class DurableStoragePolicy$DurableStorageGroupPolicy_Stub extends sapphire.policy.durable.DurableStoragePolicy.DurableStorageGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public DurableStoragePolicy$DurableStorageGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        DurableStoragePolicy$DurableStorageGroupPolicy_Stub other = (DurableStoragePolicy$DurableStorageGroupPolicy_Stub) obj;
    ...
    public sapphire.policy.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireServerPolicy sapphire.policy.durable.DurableStoragePolicy$DurableStorageGroupPolicy.onRefRequest()";
    ...
    public void onFailure(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.durable.DurableStoragePolicy$DurableStorageGroupPolicy.onFailure(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.durable.DurableStoragePolicy$DurableStorageGroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
    ...
    public java.util.ArrayList getServers() {
        String $__method = "public java.util.ArrayList<sapphire.policy.SapphirePolicy$SapphireServerPolicy> sapphire.policy.durable.DurableStoragePolicy$DurableStorageGroupPolicy.getServers()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public void addServer(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.durable.DurableStoragePolicy$DurableStorageGroupPolicy.addServer(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
