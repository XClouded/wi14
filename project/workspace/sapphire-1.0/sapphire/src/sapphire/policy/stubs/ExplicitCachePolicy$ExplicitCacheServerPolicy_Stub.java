/*
 * Stub for class sapphire.policy.cache.ExplicitCachePolicy.ExplicitCacheServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ExplicitCachePolicy$ExplicitCacheServerPolicy_Stub extends sapphire.policy.cache.ExplicitCachePolicy.ExplicitCacheServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ExplicitCachePolicy$ExplicitCacheServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ExplicitCachePolicy$ExplicitCacheServerPolicy_Stub other = (ExplicitCachePolicy$ExplicitCacheServerPolicy_Stub) obj;
    ...
    // Implementation of syncObject(Serializable)
    public void syncObject(java.io.Serializable $param_Serializable_1) {
        String $__method = "public void sapphire.policy.cache.ExplicitCachePolicy$ExplicitCacheServerPolicy.syncObject(java.io.Serializable)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_Serializable_1;
    ...
    public void onMembershipChange() {
        String $__method = "public void sapphire.policy.cache.ExplicitCachePolicy$ExplicitCacheServerPolicy.onMembershipChange()";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        String $__method = "public void sapphire.policy.cache.ExplicitCachePolicy$ExplicitCacheServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
        Object[] $__params = new Object[1];
    ...
    public sapphire.common.AppObject getObject()
            throws java.lang.Exception {
        String $__method = "public sapphire.common.AppObject sapphire.policy.cache.ExplicitCachePolicy$ExplicitCacheServerPolicy.getObject() throws java.lang.Exception";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public sapphire.policy.SapphirePolicy.SapphireGroupPolicy getGroup() {
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireGroupPolicy sapphire.policy.cache.ExplicitCachePolicy$ExplicitCacheServerPolicy.getGroup()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
