/*
 * Stub for class sapphire.policy.immutable.ImmutablePolicy.ImmutableServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class ImmutablePolicy$ImmutableServerPolicy_Stub extends sapphire.policy.immutable.ImmutablePolicy.ImmutableServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public ImmutablePolicy$ImmutableServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        ImmutablePolicy$ImmutableServerPolicy_Stub other = (ImmutablePolicy$ImmutableServerPolicy_Stub) obj;
    ...
    public void onMembershipChange() {
        String $__method = "public void sapphire.policy.immutable.ImmutablePolicy$ImmutableServerPolicy.onMembershipChange()";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireGroupPolicy $param_SapphirePolicy$SapphireGroupPolicy_1) {
        String $__method = "public void sapphire.policy.immutable.ImmutablePolicy$ImmutableServerPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireGroupPolicy)";
    ...
    // Implementation of getOID()
    public sapphire.kernel.common.KernelOID getOID() {
        String $__method = "public sapphire.kernel.common.KernelOID sapphire.policy.immutable.ImmutablePolicy$ImmutableServerPolicy.getOID()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
        ...
        return ((sapphire.kernel.common.KernelOID) $__result);
    }

    // Implementation of getGroup()
    public sapphire.policy.SapphirePolicy.SapphireGroupPolicy getGroup() {
        String $__method = "public sapphire.policy.SapphirePolicy$SapphireGroupPolicy sapphire.policy.immutable.ImmutablePolicy$ImmutableServerPolicy.getGroup()";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
    ...
    public sapphire.common.AppObject getCopy()
            throws java.lang.Exception {
        String $__method = "public sapphire.common.AppObject sapphire.policy.immutable.ImmutablePolicy$ImmutableServerPolicy.getCopy() throws java.lang.Exception";
        Object[] $__params = null;
        java.lang.Object $__result = null;
        try {
            $__result = $__makeKernelRPC($__method, $__params);
