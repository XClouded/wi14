/*
 * Stub for class sapphire.policy.scalability.LoadBalancedMasterSlave.LoadBalancedMasterSlaveGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy_Stub extends sapphire.policy.scalability.LoadBalancedMasterSlave.LoadBalancedMasterSlaveGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy_Stub other = (LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy_Stub) obj;
    ...
    public sapphire.policy.SapphirePolicy.SapphireServerPolicy onRefRequest() {
        String $__method = "public synchronized sapphire.policy.SapphirePolicy$SapphireServerPolicy sapphire.policy.scalability.LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy.onRefRequest()";
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.scalability.LoadBalancedMasterSlave$LoadBalancedMasterSlaveGroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
