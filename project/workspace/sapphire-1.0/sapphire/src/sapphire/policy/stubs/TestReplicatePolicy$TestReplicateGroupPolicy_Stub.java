/*
 * Stub for class sapphire.policy.test.TestReplicatePolicy.TestReplicateGroupPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TestReplicatePolicy$TestReplicateGroupPolicy_Stub extends sapphire.policy.test.TestReplicatePolicy.TestReplicateGroupPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TestReplicatePolicy$TestReplicateGroupPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TestReplicatePolicy$TestReplicateGroupPolicy_Stub other = (TestReplicatePolicy$TestReplicateGroupPolicy_Stub) obj;
    ...
    public void onCreate(sapphire.policy.SapphirePolicy.SapphireServerPolicy $param_SapphirePolicy$SapphireServerPolicy_1) {
        String $__method = "public void sapphire.policy.test.TestReplicatePolicy$TestReplicateGroupPolicy.onCreate(sapphire.policy.SapphirePolicy$SapphireServerPolicy)";
        Object[] $__params = new Object[1];
        $__params[0] = $param_SapphirePolicy$SapphireServerPolicy_1;
        java.lang.Object $__result = null;
        try {
