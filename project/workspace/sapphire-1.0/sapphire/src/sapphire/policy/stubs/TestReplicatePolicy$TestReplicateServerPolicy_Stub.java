/*
 * Stub for class sapphire.policy.test.TestReplicatePolicy.TestReplicateServerPolicy
 * Generated by Sapphire Compiler (sc).
 */
package sapphire.policy.stubs;


public final class TestReplicatePolicy$TestReplicateServerPolicy_Stub extends sapphire.policy.test.TestReplicatePolicy.TestReplicateServerPolicy implements sapphire.kernel.common.KernelObjectStub {

    private static final long serialVersionUID = 2L;
    sapphire.kernel.common.KernelOID $__oid = null;
    java.net.InetSocketAddress $__hostname = null;

    public TestReplicatePolicy$TestReplicateServerPolicy_Stub(sapphire.kernel.common.KernelOID oid) {
        this.$__oid = oid;
    }
    ...
    public boolean equals(Object obj) { 
        TestReplicatePolicy$TestReplicateServerPolicy_Stub other = (TestReplicatePolicy$TestReplicateServerPolicy_Stub) obj;
    ...
    public java.lang.Long replicate() {
        String $__method = "public java.lang.Long sapphire.policy.test.TestReplicatePolicy$TestReplicateServerPolicy.replicate()";
