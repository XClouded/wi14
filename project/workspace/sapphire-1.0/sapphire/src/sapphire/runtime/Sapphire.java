...
public class Sapphire {
	private static final String AppObjectStub = null;
	...
	// TODO: doesn't work when is called in constructor
	...
	/**
	 * Registers this kernel object to notify the server policy when the RPC latency is greater
	 * than max latency. This method should be called from the server policy's onCreate() method.
	 * @param serverPolicy
	 * @param maxLatency
	 */
	public static void registerKernelObject(SapphireServerPolicy serverPolicy, long maxLatency) {
		KernelOID oid = serverPolicy.$__getKernelOID();
		GlobalKernelReferences.nodeServer.registerLatencyCallback(oid, maxLatency, serverPolicy);
	}
}
